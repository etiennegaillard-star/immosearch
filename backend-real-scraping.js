...
const SCRAPER_CONFIG = {
  'petitesannonces-pf': {
    ...
    baseUrl: 'https://www.petites-annonces.pf',
    searchUrl: 'https://www.petites-annonces.pf/immobilier',
  },
};
    ...
    cards.each((index, element) => {
      try {
        ...
        if (imageUrl && !imageUrl.startsWith('http')) {
          imageUrl = 'https://www.petites-annonces.pf' + imageUrl;
        }
        ...
        if (detailUrl && !detailUrl.startsWith('http')) {
          detailUrl = 'https://www.petites-annonces.pf' + detailUrl;
        }
